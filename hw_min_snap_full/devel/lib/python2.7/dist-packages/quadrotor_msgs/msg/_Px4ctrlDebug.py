...
class Px4ctrlDebug(genpy.Message):
  _md5sum = "9ddf78a965614929f792cafb89e47f73"
...
string frame_id
"""
  __slots__ = ['header','des_p_x','des_p_y','des_p_z','des_v_x','des_v_y','des_v_z','fb_a_x','fb_a_y','fb_a_z','des_a_x','des_a_y','des_a_z','des_q_x','des_q_y','des_q_z','des_q_w','des_thr','thr2acc','thr_scale_compensate','voltage','err_axisang_x','err_axisang_y','err_axisang_z','err_axisang_ang','fb_rate_x','fb_rate_y','fb_rate_z']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,des_p_x,des_p_y,des_p_z,des_v_x,des_v_y,des_v_z,fb_a_x,fb_a_y,fb_a_z,des_a_x,des_a_y,des_a_z,des_q_x,des_q_y,des_q_z,des_q_w,des_thr,thr2acc,thr_scale_compensate,voltage,err_axisang_x,err_axisang_y,err_axisang_z,err_axisang_ang,fb_rate_x,fb_rate_y,fb_rate_z
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_27d().pack(_x.des_p_x, _x.des_p_y, _x.des_p_z, _x.des_v_x, _x.des_v_y, _x.des_v_z, _x.fb_a_x, _x.fb_a_y, _x.fb_a_z, _x.des_a_x, _x.des_a_y, _x.des_a_z, _x.des_q_x, _x.des_q_y, _x.des_q_z, _x.des_q_w, _x.des_thr, _x.thr2acc, _x.thr_scale_compensate, _x.voltage, _x.err_axisang_x, _x.err_axisang_y, _x.err_axisang_z, _x.err_axisang_ang, _x.fb_rate_x, _x.fb_rate_y, _x.fb_rate_z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.des_p_x, _x.des_p_y, _x.des_p_z, _x.des_v_x, _x.des_v_y, _x.des_v_z, _x.fb_a_x, _x.fb_a_y, _x.fb_a_z, _x.des_a_x, _x.des_a_y, _x.des_a_z, _x.des_q_x, _x.des_q_y, _x.des_q_z, _x.des_q_w, _x.des_thr, _x.thr2acc, _x.thr_scale_compensate, _x.voltage, _x.err_axisang_x, _x.err_axisang_y, _x.err_axisang_z, _x.err_axisang_ang, _x.fb_rate_x, _x.fb_rate_y, _x.fb_rate_z,) = _get_struct_27d().unpack(str[start:end])
      return self

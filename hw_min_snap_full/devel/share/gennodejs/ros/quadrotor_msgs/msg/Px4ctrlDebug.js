...
class Px4ctrlDebug {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('thr2acc')) {
        this.thr2acc = initObj.thr2acc
      }
      else {
        this.thr2acc = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [thr2acc]
    bufferOffset = _serializer.float64(obj.thr2acc, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [thr2acc]
    data.thr2acc = _deserializer.float64(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.thr2acc !== undefined) {
      resolved.thr2acc = msg.thr2acc;
    }
    else {
      resolved.thr2acc = 0.0
    }
